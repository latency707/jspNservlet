	...
	<form action="requestTest1.jsp" method="post">
		<table>
			...
			<tr>
				...
				<td>남<input type="radio" name="gender" value="male" id 
				= "gender">여<input type="radio" name="gender" value="female">
				</td>
			</tr>
			<tr>
				...
				id = "hobby">
					...
					기타<input type="checkbox" name="hobby" vallue="기타">
				</td>
			</tr>
			<tr>
